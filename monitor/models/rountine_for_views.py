...
def get_update_data():
    ...
    for userId in userId_list:
        ...
        # df_account_old.rename(columns={'available': 'Available', 'balance': 'Balance',
        #                                'frozen': 'Frozen', 'currency':'Currency'},
        #                       inplace=True)

        local_date_str = get_local_datetime(format_str='%Y-%m-%d')
        lastDay_datetime = local_date_str + ' 12:00:00'
